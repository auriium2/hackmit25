...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Retrieve seed papers for a research query")
    parser.add_argument("query", type=str, help="Research query to search for")
    parser.add_argument("--email", type=str, default=None, help="Contact email for OpenAlex (recommended)")
    parser.add_argument("--api_key", type=str, default=None, help="Claude API key (optional if hardcoded)")
    args = parser.parse_args()

    retriever = SeedPaperRetriever(email=args.email, openai_api_key=args.api_key)

    logger.info("Starting seed paper retrieval...")
    seed_dois = retriever.retrieve_seed_papers(args.query)
    ...
    if seed_dois:
        ...
        print("\nNo seed papers found for this query.")
