...
const App: React.FC = () => {
  ...
  return (
    <div style={{ display: "flex", height: "100vh", fontFamily: "Arial, sans-serif", overflow: "hidden" }}>
      ...
      <div style={{ width: "300px", minWidth: "300px", maxWidth: "300px", borderRight: "1px solid #ddd", overflow: "auto", flexShrink: 0 }}>
        <FilterPanel
          filters={filters}
      ...
      <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        ...
        <div style={{ flex: 1, padding: "20px", overflow: "hidden", minHeight: 0 }}>
          <GraphVisualization
            nodes={nodes}
            edges={edges}
      ...
      <div style={{ width: "400px", minWidth: "400px", maxWidth: "400px", borderLeft: "1px solid #ddd", overflow: "auto", flexShrink: 0 }}>
